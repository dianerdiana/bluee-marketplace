...
export const InputWrapper: FC<InputWrapperProps> = ({ children, className, isInvalid = false, ...props }) => (
  <div
    className={cn(
      'flex items-center gap-3 p-[16px_12px] border border-secondary rounded-xl focus-within:ring focus-within:ring-primary focus-within:border-primary transition-all duration-300',
      isInvalid
